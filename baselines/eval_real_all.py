    ...
    if args.dataset == 'ldct':
        ...
        boosters = [
            ...
            ('endpoint_unet_res', f'{OUT_ROOT}/ldct_unet_res_endpoint_uniform/best.pth',
             'unet_res_ep', None),
            ('bridge_redcnn_EI', f'{OUT_ROOT}/ldct_redcnn_bridge_equal_improvement/best.pth',
             'redcnn_blind', alpha),
            ('endpoint_redcnn', f'{OUT_ROOT}/ldct_redcnn_endpoint_equal_improvement_alt/best.pth',
             'redcnn_endpoint', None),
            ('endpoint_redcnn_r6ep400', f'{OUT_ROOT}/ldct_redcnn_endpoint_equal_improvement/best.pth',
             'redcnn_endpoint', None),
            ('endpoint_redcnn_r6ep100', f'{OUT_ROOT}/ldct_redcnn_endpoint_equal_improvement/best.pth',
             'redcnn_endpoint', None),
            ('endpoint_unet_res', f'{OUT_ROOT}/ldct_unet_res_endpoint_equal_improvement/best.pth',
             'unet_res_ep', None),
            ('endpoint_dncnn', f'{OUT_ROOT}/ldct_dncnn_endpoint_equal_improvement/best.pth', 'r6:dncnn', None),
            ('endpoint_edcnn', f'{OUT_ROOT}/ldct_edcnn_endpoint_equal_improvement/best.pth', 'r6:edcnn', None),
            ('endpoint_nafnet', f'{OUT_ROOT}/ldct_nafnet_endpoint_equal_improvement/best.pth', 'r6:nafnet', None),
            ('endpoint_drunet', f'{OUT_ROOT}/ldct_drunet_endpoint_equal_improvement/best.pth', 'r6:drunet', None),
            ('endpoint_mapnn', f'{OUT_ROOT}/ldct_mapnn_endpoint_equal_improvement/best.pth', 'r6:mapnn', None),
            ('endpoint_restormer', f'{OUT_ROOT}/ldct_restormer_endpoint_equal_improvement/best.pth', 'r6:restormer', None),
            ('endpoint_wganvgg_pub', f'{OUT_ROOT}/ldct_wganvgg_endpoint_equal_improvement_pub/best.pth', 'r6:wganvgg', None),
            ('bridge_redcnn_wide_EI', f'{OUT_ROOT}/ldct_redcnn_wide_bridge_equal_improvement/best.pth',
             'wide_blind', alpha),
            ('ours_unet_res_aug', f'{OUT_ROOT}/ldct_unet_res_bridge_uniform_aug_ema/best.pth',
             'unet_res_t:uniform', alpha),
            ('ours_unet_res_aug_lr2e4', f'{OUT_ROOT}/ldct_unet_res_bridge_uniform_aug_ema_lr0.0002/best.pth',
             'unet_res_t:uniform', alpha),
            ('ours_unet96_aug_lr2e4', f'{OUT_ROOT}/ldct_unet_res96_bridge_uniform_aug_ema_lr0.0002/best.pth',
             'unet_res96_t:uniform', alpha),
            ('ours_hybrid_rep4', f'{OUT_ROOT}/ldct_rep4_hybrid_bridge_uniform_aug_ema_lr0.0002/best.pth',
             'hybrid_t:uniform', alpha),
            ('ours_hybrid_rep1', f'{OUT_ROOT}/ldct_hybrid_bridge_uniform_aug_ema_lr0.0002/best.pth',
             'hybrid_t:uniform', alpha),
            ('endpoint_unet_res_aug', f'{OUT_ROOT}/ldct_unet_res_endpoint_uniform_aug_ema/best.pth',
             'unet_res_ep', None),
            ('endpoint_redcnn_aug', f'{OUT_ROOT}/ldct_redcnn_endpoint_equal_improvement_aug_ema/best.pth',
             'redcnn_endpoint', None),
            ('endpoint_edcnn_aug', f'{OUT_ROOT}/ldct_edcnn_endpoint_equal_improvement_aug_ema/best.pth',
             'edcnn_endpoint', None),
            ('endpoint_redcnn_wide_aug', f'{OUT_ROOT}/ldct_redcnn_wide_endpoint_equal_improvement_aug_ema/best.pth',
             'wide_endpoint', None),
            ('endpoint_redcnn_wide', f'{OUT_ROOT}/ldct_redcnn_wide_endpoint_equal_improvement/best.pth',
             'wide_endpoint', None),
        ]
        pairs = cache_ldct()
    else:
        ...
        boosters = [
            ...
            ('endpoint_unet_res_effI0', f'{OUT_ROOT}/2detect_effI0_unet_res_endpoint_geometric/best.pth',
             'unet_res_ep', None),
            ('endpoint_redcnn_effI0', f'{OUT_ROOT}/2detect_effI0_redcnn_endpoint_geometric/best.pth',
             'redcnn_endpoint', None),
            ('endpoint_dncnn_effI0', f'{OUT_ROOT}/2detect_effI0_dncnn_endpoint_geometric/best.pth', 'r6:dncnn', None),
            ('endpoint_edcnn_effI0', f'{OUT_ROOT}/2detect_effI0_edcnn_endpoint_geometric/best.pth', 'r6:edcnn', None),
            ('endpoint_nafnet_effI0', f'{OUT_ROOT}/2detect_effI0_nafnet_endpoint_geometric/best.pth', 'r6:nafnet', None),
            ('endpoint_drunet_effI0', f'{OUT_ROOT}/2detect_effI0_drunet_endpoint_geometric/best.pth', 'r6:drunet', None),
            ('endpoint_mapnn_effI0', f'{OUT_ROOT}/2detect_effI0_mapnn_endpoint_geometric/best.pth', 'r6:mapnn', None),
            ('endpoint_restormer_effI0', f'{OUT_ROOT}/2detect_effI0_restormer_endpoint_geometric/best.pth', 'r6:restormer', None),
            ('endpoint_wganvgg_effI0_pub', f'{OUT_ROOT}/2detect_effI0_wganvgg_endpoint_geometric_pub/best.pth', 'r6:wganvgg', None),
            ('bridge_redcnn_effI0', f'{OUT_ROOT}/2detect_effI0_redcnn_bridge_geometric/best.pth',
             'redcnn_blind', 425.0 / 15000.0),
            ('endpoint_redcnn_effI0_alt', f'{OUT_ROOT}/2detect_effI0_redcnn_endpoint_geometric_alt/best.pth',
             'redcnn_endpoint', None),
            ('bridge_redcnn_wide_effI0', f'{OUT_ROOT}/2detect_effI0_redcnn_wide_bridge_geometric/best.pth',
             'wide_blind', 425.0 / 15000.0),
            ('endpoint_redcnn_wide_effI0', f'{OUT_ROOT}/2detect_effI0_redcnn_wide_endpoint_geometric/best.pth',
             'wide_endpoint', None),
            ('ours_unet_res_effI0_aug', f'{OUT_ROOT}/2detect_effI0_unet_res_bridge_geometric_aug_ema/best.pth',
             'unet_res_t:geometric', 425.0 / 15000.0),
            ('ours_unet96_effI0_aug_lr2e4', f'{OUT_ROOT}/2detect_effI0_unet_res96_bridge_geometric_aug_ema_lr0.0002/best.pth',
             'unet_res96_t:geometric', 425.0 / 15000.0),
            ('ours_unet96ref_effI0_aug_lr2e4', f'{OUT_ROOT}/2detect_effI0_unet_res96_ref_bridge_geometric_aug_ema_lr0.0002/best.pth',
             'unet_res96_ref_t:geometric', 425.0 / 15000.0),
            ('ours_hybrid96_effI0_aug_lr2e4', f'{OUT_ROOT}/2detect_effI0_hybrid96_bridge_geometric_aug_ema_lr0.0002/best.pth',
             'hybrid96_t:geometric', 425.0 / 15000.0),
            ('endpoint_unet_res_effI0_aug', f'{OUT_ROOT}/2detect_effI0_unet_res_endpoint_geometric_aug_ema/best.pth',
             'unet_res_ep', None),
            ('endpoint_redcnn_effI0_aug', f'{OUT_ROOT}/2detect_effI0_redcnn_endpoint_geometric_aug_ema/best.pth',
             'redcnn_endpoint', None),
            ('endpoint_redcnn_wide_effI0_aug', f'{OUT_ROOT}/2detect_effI0_redcnn_wide_endpoint_geometric_aug_ema/best.pth',
             'wide_endpoint', None),
        ]
        pairs = cache_2detect()
