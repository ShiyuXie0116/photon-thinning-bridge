...
def main():
    ...
    if args.dataset == '2detect':
        ...
        models = [
            ...
            ('redcnn_EI_alt', f'{OUT_ROOT}/2detect_redcnn_bridge_equal_improvement/best.pth',
             True, 'equal_improvement', alpha),
            ('wide_EI', f'{OUT_ROOT}/2detect_redcnn_wide_bridge_equal_improvement/best.pth',
             'wide', 'equal_improvement', alpha),
            ('wide_EI_alt', f'{OUT_ROOT}/2detect_redcnn_wide_bridge_equal_improvement_alt/best.pth',
             'wide', 'equal_improvement', alpha),
            ...
            ('ures_aug160', f'{OUT_ROOT}/2detect_unet_res_bridge_uniform_aug_ema/best.pth',
             'res', 'uniform', alpha),
            ('ures_aug160_EI', f'{OUT_ROOT}/2detect_unet_res_bridge_uniform_aug_ema/best.pth',
             'res', 'equal_improvement', alpha),
            ('ures_aug320', f'{OUT_ROOT}/2detect_unet_res_bridge_uniform_aug_ema_alt/best.pth',
             'res', 'uniform', alpha),
            ('ures_rep4', f'{OUT_ROOT}/2detect_rep4_unet_res_bridge_uniform_aug_ema/best.pth',
             'res', 'uniform', alpha),
            ('ures_rep4_160', f'{OUT_ROOT}/2detect_rep4_unet_res_bridge_uniform_aug_ema/best.pth',
             'res', 'uniform', alpha),
            ('ures96ref_rep4v2', f'{OUT_ROOT}/2detect_rep4_unet_res96_ref_bridge_uniform_aug_ema_lr0.0002v2/best.pth',
             'ref96', 'uniform', 0.01),
            ('ures96ref_rep4v2_EI', f'{OUT_ROOT}/2detect_rep4_unet_res96_ref_bridge_uniform_aug_ema_lr0.0002v2/best.pth',
             'ref96', 'equal_improvement', 0.01),
            ('ures96_rep4v2', f'{OUT_ROOT}/2detect_rep4_unet_res96_bridge_uniform_aug_ema_lr0.0002v2/best.pth',
             'res96', 'uniform', alpha),
            ('ures96_rep4v2_EI', f'{OUT_ROOT}/2detect_rep4_unet_res96_bridge_uniform_aug_ema_lr0.0002v2/best.pth',
             'res96', 'equal_improvement', alpha),
            ('hyb96_rep4', f'{OUT_ROOT}/2detect_rep4_hybrid96_bridge_uniform_aug_ema_lr0.0002/best.pth',
             'hyb96', 'uniform', alpha),
            ('hyb96_rep4_EI', f'{OUT_ROOT}/2detect_rep4_hybrid96_bridge_uniform_aug_ema_lr0.0002/best.pth',
             'hyb96', 'equal_improvement', alpha),
            ('ures96_aug160', f'{OUT_ROOT}/2detect_unet_res96_bridge_uniform_aug_ema/best.pth',
             'res96', 'uniform', alpha),
            ('ures48_aug160', f'{OUT_ROOT}/2detect_unet_res48_bridge_uniform_aug_ema/best.pth',
             'res48', 'uniform', alpha),
            ('ures_lr2e4', f'{OUT_ROOT}/2detect_unet_res_bridge_uniform_aug_ema_lr0.0002/best.pth',
             'res', 'uniform', alpha),
            ('ures_bs32', f'{OUT_ROOT}/2detect_unet_res_bridge_uniform_aug_ema_bs32/best.pth',
             'res', 'uniform', alpha),
        ]
        ...
        models = [
            ...
            ('ures_EI', f'{OUT_ROOT}/ldct_unet_res_bridge_equal_improvement/best.pth',
             'res', 'equal_improvement', alpha),
            ('redcnn_EI', f'{OUT_ROOT}/ldct_redcnn_bridge_equal_improvement/best.pth',
             True, 'equal_improvement', alpha),
            ('wide_EI', f'{OUT_ROOT}/ldct_redcnn_wide_bridge_equal_improvement/best.pth',
             'wide', 'equal_improvement', alpha),
            ('ures_aug', f'{OUT_ROOT}/ldct_unet_res_bridge_uniform_aug_ema/best.pth',
             'res', 'uniform', alpha),
                ('ldhyb4_real', f'{OUT_ROOT}/ldct_rep4_hybrid_bridge_uniform_aug_ema_lr0.0002/best.pth',
                 'hyb', 'uniform', alpha),
                ('ldhyb1_real', f'{OUT_ROOT}/ldct_hybrid_bridge_uniform_aug_ema_lr0.0002/best.pth',
                 'hyb', 'uniform', alpha),
            ('ures_aug_lr2e4', f'{OUT_ROOT}/ldct_unet_res_bridge_uniform_aug_ema_lr0.0002/best.pth',
             'res', 'uniform', alpha),
            ('ures96_aug_lr2e4', f'{OUT_ROOT}/ldct_unet_res96_bridge_uniform_aug_ema_lr0.0002/best.pth',
             'res96', 'uniform', alpha),
        ]
        ...
        if args.dataset == 'real_ldct':
            ...
            models = [
                ...
                ('ures_effI0', f'{OUT_ROOT}/2detect_effI0_unet_res_bridge_geometric/best.pth',
                 'res', 'geometric', a_eff),
                ('redcnn_effI0', f'{OUT_ROOT}/2detect_effI0_redcnn_bridge_geometric/best.pth',
                 True, 'geometric', a_eff),
                ('wide_effI0', f'{OUT_ROOT}/2detect_effI0_redcnn_wide_bridge_geometric/best.pth',
                 'wide', 'geometric', a_eff),
                ('ures_effI0_aug', f'{OUT_ROOT}/2detect_effI0_unet_res_bridge_geometric_aug_ema/best.pth',
                 'res', 'geometric', a_eff),
                ('ures96_effI0_aug', f'{OUT_ROOT}/2detect_effI0_unet_res96_bridge_geometric_aug_ema_lr0.0002/best.pth',
                 'res96', 'geometric', a_eff),
                ('ures96ref_effI0_aug', f'{OUT_ROOT}/2detect_effI0_unet_res96_ref_bridge_geometric_aug_ema_lr0.0002/best.pth',
                 'ref96', 'geometric', a_eff),
                ('hyb96_effI0_aug', f'{OUT_ROOT}/2detect_effI0_hybrid96_bridge_geometric_aug_ema_lr0.0002/best.pth',
