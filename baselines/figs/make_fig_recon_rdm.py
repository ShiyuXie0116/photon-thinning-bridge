...
CFG = {
    'ldct': dict(pre=f"{DATA_ROOT}/LDCT_dose_bridge/precomputed_equal_improvement", hu=(-1090.1, 1264.6),
                 ...
                 methods=[('Input', None, None),
                          ...
                          ('MAP-NN', f'{B}/eval_sweep_ldct_ep100/preds/mapnn_endpoint_equal_improvement_{TAG}.npz', f'mapnn_endpoint_equal_improvement_{TAG}'),
                          ('EDCNN', f'{B}/eval_sweep_ldct_ep100/preds/edcnn_endpoint_equal_improvement_{TAG}.npz', f'edcnn_endpoint_equal_improvement_{TAG}'),
                          ('DnCNN', f'{B}/eval_sweep_ldct_ep100/preds/dncnn_endpoint_equal_improvement_{TAG}.npz', f'dncnn_endpoint_equal_improvement_{TAG}'),
                          ('Reference', None, None),
                          ('NAFNet', f'{B}/eval_sweep_ldct_ep100/preds/nafnet_endpoint_equal_improvement_{TAG}.npz', f'nafnet_endpoint_equal_improvement_{TAG}@t1'),
                          ('Restormer', f'{B}/eval_sweep_ldct_ep100/preds/restormer_endpoint_equal_improvement_{TAG}.npz', f'restormer_endpoint_equal_improvement_{TAG}'),
                          ('U-Net', f'{B}/eval_sweep_ldct_ep100/preds/unet_res_endpoint_equal_improvement_{TAG}.npz', f'unet_res_endpoint_equal_improvement_{TAG}@t1'),
                          ('RED-CNN', f'{B}/eval_sweep_ldct_ep100/preds/redcnn_endpoint_equal_improvement_{TAG}.npz', f'redcnn_endpoint_equal_improvement_{TAG}'),
                          ('DRUNet', f'{B}/eval_sweep_ldct_ep100/preds/drunet_endpoint_equal_improvement_{TAG}.npz', f'drunet_endpoint_equal_improvement_{TAG}@t1'),
    ...
    '2detect': dict(pre=f"{DATA_ROOT}/2DeteCT_dose_bridge/precomputed_equal_improvement", hu=None,
                    ...
                    methods=[('Input', None, None),
                             ...
                             ('MAP-NN', f'{B}/eval_sweep_2detect_ep100/preds/mapnn_endpoint_uniform_{TAG}.npz', f'mapnn_endpoint_uniform_{TAG}'),
                             ('WGAN-VGG', f'{B}/eval_sweep_2detect/preds/wganvgg_endpoint_uniform_pub.npz', 'wganvgg_endpoint_uniform_pub'),
                             ('NAFNet', f'{B}/eval_sweep_2detect_ep100/preds/nafnet_endpoint_uniform_{TAG}.npz', f'nafnet_endpoint_uniform_{TAG}@t1'),
                             ('Restormer', f'{B}/eval_sweep_2detect_ep100/preds/restormer_endpoint_uniform_{TAG}.npz', f'restormer_endpoint_uniform_{TAG}'),
                             ('Reference', None, None),
                             ('DnCNN', f'{B}/eval_sweep_2detect_ep100/preds/dncnn_endpoint_uniform_{TAG}.npz', f'dncnn_endpoint_uniform_{TAG}'),
                             ('EDCNN', f'{B}/eval_sweep_2detect_ep100/preds/edcnn_endpoint_uniform_{TAG}.npz', f'edcnn_endpoint_uniform_{TAG}'),
                             ('DRUNet', f'{B}/eval_sweep_2detect_ep100/preds/drunet_endpoint_uniform_{TAG}.npz', f'drunet_endpoint_uniform_{TAG}@t1'),
                             ('RED-CNN', f'{B}/eval_sweep_2detect_ep100/preds/redcnn_endpoint_uniform_{TAG}.npz', f'redcnn_endpoint_uniform_{TAG}'),
                             ('U-Net', f'{B}/eval_sweep_2detect_ep100/preds/unet_res_endpoint_uniform_{TAG}.npz', f'unet_res_endpoint_uniform_{TAG}@t1'),
